...
#product flag number contains Membership license
...
"USE " + $Database + "
    ...
    VALUES('" + $tk + "', '0633ECE3-D78C-45C9-A8C7-338D3E830E8A'),
    ('" + $tk + "', '0826FD0F-62FD-4A5F-84CD-C79FAAF1CCA0'),
     ...
     LastName in ('Test','Diego','Admin','opt-out','Author')  AND
         FirstName in (
     	    ...
     	    'authenticated', 'grandma', 'moderateduser', 'InternSean', 'Developer', 'Tester',
     	     ...
     	     'Daenerys', 'Authenticatednonmember2', 'Groupmemberone', 'communitymoderator', 'irenewsamenoar',
     	     ...
     	     'sirfach', 'dirfach', 'sgrfach', 'dgrfach', 'srssiach', 'srsdiach', 'gsrssach', 'gsrsdach', 'ifsd', 'ifsdc'
         ) OR FirstName = 'Member'"
);
